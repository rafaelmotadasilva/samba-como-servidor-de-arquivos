...
* *[O arquivo de configuração usado como exemplo está disponível aqui](https://github.com/rafaelmotadasilva/samba-file-server/blob/main/smb.conf)*
...
* *[O arquivo de shell script usado como exemplo está disponível aqui](https://github.com/rafaelmotadasilva/samba-file-server/blob/main/samba-file-server.sh)*
